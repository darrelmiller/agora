...
exports.actionCreators = {
    processCSDL: function () { return function (dispatch, getState) {
            ...
            fetch("openapi", { method: "POST", body: appState.apiDescription.csdl })
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = {
                                openApiUrl: response.headers.get("Content-Location")
                            };
                            return [4 /*yield*/, response.text()];
                        case 1: return [2 /*return*/, (_a.openApi = (_b.sent()),
                                _a)];
                    }
                });
            }); })
    ...
    updateCsdl: function (newValue) { return ({ type: 'UPDATE_CSDL', csdl: newValue }); },
    updateSearchTerm: function (newValue) { return ({ type: 'UPDATE_SEARCHTERM', searchTerm: newValue }); },
    searchForTerm: function () { return function (dispatch, getState) {
        var appState = getState();
        if (appState && appState.apiDescription && appState.apiDescription.csdl) {
